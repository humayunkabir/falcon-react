  ...
  [0],
  {
    ...
    990: function(e, a, t) {
      ...
      var A = t(5),
        ...
        i = t.n(o),
        u = t(2),
        g = s.a.oneOfType([s.a.number, s.a.string]),
        m = s.a.oneOfType([s.a.string, s.a.number, s.a.shape({ size: g, order: g, offset: g })]),
        f = {
          children: s.a.node,
          hidden: s.a.bool,
          check: s.a.bool,
        ...
        d = function(e) {
          ...
          r.forEach(function(a, A) {
            ...
            if ((delete f[a], n || '' === n)) {
              ...
              } else (c = E(l, a, n)), w.push(c);
            }
          });
          var d = Object(u.mapToCssModules)(
            i()(
              a,
              !!c && 'sr-only',
              !!o && 'form-check-label',
              !!g && 'col-form-label-' + g,
              w,
              !!w.length && 'col-form-label'
            ),
            t
          );
          return l.a.createElement(s, Object(A.a)({ htmlFor: m }, f, { className: d }));
        };
      (d.propTypes = f), (d.defaultProps = w), (a.a = d);
    },
    991: function(e, a, t) {
      'use strict';
      var A = t(18),
...
//# sourceMappingURL=0.d60269b6.chunk.js.map
