!(function(e) {
  function t(t) {
    for (var n, o, u = t[0], f = t[1], i = t[2], d = 0, s = []; d < u.length; d++)
      (o = u[d]), c[o] && s.push(c[o][0]), (c[o] = 0);
        ...
        t.push(
          (o[e] = new Promise(function(t, r) {
            for (
              ...
              var i = (l = a[f]).getAttribute('data-href') || l.getAttribute('href');
              if ('stylesheet' === l.rel && (i === n || i === c)) return t();
            }
            var d = document.getElementsByTagName('style');
            for (f = 0; f < d.length; f++) {
              var l;
              if ((i = (l = d[f]).getAttribute('data-href')) === n || i === c) return t();
            }
...
//# sourceMappingURL=runtime~main.aef5718c.js.map
